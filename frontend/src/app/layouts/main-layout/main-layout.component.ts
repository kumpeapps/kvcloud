...
export class MainLayoutComponent {
  ...
  menuItems: MenuItem[] = [
    ...
    { icon: 'storefront', label: 'Browse Plans', route: '/plans' },
    { icon: 'shopping_cart', label: 'My Requests', route: '/requests/cart' },
    ...
    { icon: 'admin_panel_settings', label: 'VM Request Approvals', route: '/admin/approvals', requiredRole: 'admin' },
    { icon: 'settings_applications', label: 'Plans Manager', route: '/plans/manager', requiredRole: 'admin' },
